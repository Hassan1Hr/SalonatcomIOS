...
class myOrders: UIViewController {
    ...
    fileprivate func setupStackView(stackView : UIStackView){
        ...
        leftbtn.titleLabel?.font = UIFont(name:"HelveticaNeue-bold", size: 18)
        centerbtn.titleLabel?.font = UIFont(name:"HelveticaNeue-bold", size: 18)
        rightbtn.titleLabel?.font = UIFont(name:"HelveticaNeue-bold", size: 19)
        leftbtn.setTitleColor(.black, for: .normal)
        centerbtn.setTitleColor(.black, for: .normal)
        rightbtn.setTitleColor(.black, for: .normal)
...
extension myOrders : UITableViewDelegate , UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.deletIcon.setImage(UIImage(named: "remove"), for: .normal)
        cell.dateIcon.image = UIImage(named: "date")
        cell.data.text = infoOrders[indexPath.row].reservation_date
